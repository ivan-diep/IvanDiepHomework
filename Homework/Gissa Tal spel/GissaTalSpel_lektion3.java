...
public static void guess(int choice, int NummerAttGissa, int Gissa, int Gissningar) {
	//Metod så ja slipper skriva om koden flera gånger när jag ändå kommer använda samma kod.
	...
	if(choice == 4) {	
		System.out.println("Hej då.");
              System.exit(0);
              //den tväravlsutar programet
	}
	// här kommer olika många tal att gissa beroende på vilken nivå du väljer.
	...
	System.out.println("Välj en ny nivå om du vill spela igen, annars välj val #4.");
	}
